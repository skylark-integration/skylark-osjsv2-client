module.exports = {
    ...
    'ERR_APP_RESOURCES_MISSING_FMT': "\xA1La aplicación  '{0}' no pudo obtener los recursos necesarios, o falló al cargarse!",
    'ERR_APP_PRELOAD_FAILED_FMT': "Error en la precarga de la application '{0}': \n{1}",
    'ERR_APP_LAUNCH_ALREADY_RUNNING_FMT': "\xA1La aplicación '{0}' ya está ejecutándose y sólo permite una instancia!",
    'ERR_APP_LAUNCH_MANIFEST_FAILED_FMT': "\xA1Error al abrir '{0}'. No se encontraron los datos del manifiesto de la aplicación!",
    'ERR_APP_LAUNCH_COMPABILITY_FAILED_FMT': "\xA1Error al abrir '{0}'. Tu explorador no da soporte: {1}",
    ...
    'ERR_CORE_INIT_NO_WM': 'No se puede lanzar OS.js: \xA1No se definió ningún gestor de ventanas!',
    ...
    'MSG_SESSION_WARNING': '\xBFEstás seguro de que quieres salir de OS.js? Se perderán todas las configuraciones y datos que no se hayan guardado',
    ...
    'DIALOG_LOGOUT_TITLE': 'Finalizar sesión (Salir)',
    'DIALOG_LOGOUT_MSG_FMT': "Usuario '{0}' desconectando.\n\xBFQuieres guardar la sesión en curso?",
    'DIALOG_CLOSE': 'Cerrar',
    ...
    'DIALOG_FILE_OVERWRITE': "\xBFSeguro que quieres sobreescribir el fichero '{0}'?",
    ...
    'DIALOG_FILE_MISSING_FILENAME': '\xA1Tienes que seleccionar un archivo o introducir un nombre de archivo nuevo!',
    'DIALOG_FILE_MISSING_SELECTION': '\xA1Tienes que seleccionar un archivo!',
    ...
    'MSG_GENERIC_APP_DISCARD': '\xBFDescartar cambios?',
    'MSG_FILE_CHANGED': 'El archivo ha cambiado. \xBFRecargar?',
