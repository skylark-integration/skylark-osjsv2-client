module.exports = {
    ...
    'ERR_APP_LAUNCH_FAILED_FMT': 'Ïîëó\xF7è ñå ãðåøêà ïî âðåìå íà ñòàðòèðàíå: {0}',
    ...
    'ERR_APP_LAUNCH_ALREADY_RUNNING_FMT': "Ïðèëîæåíèåòî '{0}' å âå\xF7å ñòàðòèðàíî!",
    ...
    'ERR_JAVACSRIPT_EXCEPTION_DESC': 'Ïîÿâè ñå íåî\xF7êàâàíà ãðåøêà, âåðîÿòíî áúã.',
    ...
    'ERR_OPERATION_TIMEOUT': 'Ïðåñðî\xF7åíî âðåìå íà îïåðàöèÿòà',
    'ERR_OPERATION_TIMEOUT_FMT': 'Ïðåñðî\xF7åíî âðåìå íà îïåðàöèÿòà ({0})',
    'ERR_WIN_DUPLICATE_FMT': "Âå\xF7å èìà íàèìåíîâàí ïðîçîðåö '{0}'",
    ...
    'MSG_SESSION_WARNING': 'Ñèãóðíè ëè ñòå, \xF7å èñêàòå íà èçëåçåòå îò OS.js? Âñè\xF7êè íå çàïàçåíè íàñòðîéêè è èíôîðìàöèÿ ùå áúäàò çàãóáåíè!',
    'BUGREPORT_MSG': 'Ìîëÿ äîêëàäâàéòå òîâà àêî ìèñëèòå, \xF7å å áúã.âêëþ\xF7åòå äåòàéëíî îïèñàíèå êàê ñå ïîëó\xF7è ãðåøêàòà è ñàìî àêî ìîæåòå; êàê ìîæå äà áúäå ïîïðàâåíà ',
    ...
    'DIALOG_LOGOUT_TITLE': 'Èçëåç (Èçõîä)',
    ...
    'DIALOG_FILE_OVERWRITE': "Ñèãóðíè ëè ñòå, \xF7å èñêàòå äà ïðåçàïèøåòå ôàèëúò '{0}'?",
    ...
    'DIALOG_UPLOAD_FAILED_UNKNOWN': 'Íåîïðåäåëåíà ïðè\xF7èíà...',
    ...
    'GAPI_DISABLED': 'GoogleAPI Ìîäóë íå å êîíôèãóðèðàí èëè å èçêëþ\xF7åí',
    ...
    'WLAPI_DISABLED': 'Windows Live API ìîäóë íå å êîíôèãóðèðàí èëè å èçêëþ\xF7åí',
    ...
    'ERR_VFS_UNAVAILABLE': 'Íå â íàëè\xF7íî',
    'ERR_VFS_FILE_ARGS': 'Ôàéëúò î\xF7àêâà ïîíå åäèí àðãóìåíò',
    'ERR_VFS_NUM_ARGS': 'Íÿìà äîñòàòú\xF7íî àðãóìåíòè',
    'ERR_VFS_EXPECT_FILE': 'Î\xF7àêâà ôàéëîâ-îáåêò',
    'ERR_VFS_EXPECT_SRC_FILE': 'Î\xF7êâà èçòî\xF7íèê Ôàéëîâ-îáåêò',
    'ERR_VFS_EXPECT_DST_FILE': 'Î\xF7àêâà äåñòèíàöèÿ Ôàéëîâ-îáåêò',
    'ERR_VFS_FILE_EXISTS': 'Äåñòèíàöèÿòà âå\xF7å ñúùåñòâóâà',
    ...
    'ERR_VFSMODULE_PARENT': 'Íÿìà íàìåðåí èçòî\xF7íèê',
    'ERR_VFSMODULE_PARENT_FMT': 'Íå ìîæà äà áúäå íàìåðåí èçòî\xF7íêè: {0}',
    'ERR_VFSMODULE_SCANDIR': 'Ïðîâàëåíî ñêàíèðàíå íà äèðåêòîðèÿ',
    'ERR_VFSMODULE_SCANDIR_FMT': 'Ïðîâàëåíî ñêàíèðàíå íà äèðåêòîðèÿ: {0}',
    'ERR_VFSMODULE_READ': 'Ïðîâàëåíî ïðî\xF7èòàíå íà ôàéëúò',
    'ERR_VFSMODULE_READ_FMT': 'Ïðîâàëåíî ïðî\xF7èòàíå íà ôàéëúò: {0}',
    ...
    'ERR_VFSMODULE_UNLINK': 'Ïðîâàëåíî ðàçêà\xF7àíå íà ôàéëúò ',
    'ERR_VFSMODULE_UNLINK_FMT': 'Ïðîâàëåíî ðàçêà\xF7àíå íà ôàéëúò: {0}',
    ...
    'ERR_VFSMODULE_FILEINFO': 'Ïðîâàëåíî ïîëó\xF7àâàíå íà èíôîðìàöèÿ çà ôàéëúò',
    'ERR_VFSMODULE_FILEINFO_FMT': 'Ïðîâàëåíî ïîëó\xF7àâàíå íà èíôîðìàöèÿ çà ôàéëúò: {0}',
    'ERR_VFSMODULE_MKDIR': 'Ïðîâàëåíî ñúçäàâàíå íà äèðåêòîðèÿ',
    'ERR_VFSMODULE_MKDIR_FMT': 'Ïðîâàëåíî ñúçäàâàíå íà äèðåêòîðèÿ: {0}',
    'ERR_VFSMODULE_URL': 'Ïðîâàëåíî ïîëó\xF7àâàíå íà URL çà ôàéëúò',
    'ERR_VFSMODULE_URL_FMT': 'Ïðîâàëåíî ïîëó\xF7àâàíå íà URL çà ôàéëúò: {0}',
    'ERR_VFSMODULE_TRASH': 'Ïðîâàëåíî èçòðèâàíå',
    'ERR_VFSMODULE_TRASH_FMT': 'Ïðîâàëåíî èçòðèâàíå: {0}',
    'ERR_VFSMODULE_UNTRASH': 'Ïðîâàëåíî èçêàðâàíå îò êîø\xF7åòî',
    'ERR_VFSMODULE_UNTRASH_FMT': 'Ïðîâàëåíî èçêàðâàíå îò êîø\xF7åòî: {0}',
    'ERR_VFSMODULE_EMPTYTRASH': 'Ïðîâàëåíî èçïðàçâàíå íà êîø\xF7åòî',
    'ERR_VFSMODULE_EMPTYTRASH_FMT': 'Ïðîâàëåíî èçïðàçâàíå íà êîø\xF7åòî: {0}',
    ...
    'ERR_PACKAGE_EXISTS': 'Äèðåêòîðèÿ çà èíñòàëèðàíå íà ïàêåòè âå\xF7å ñúùåñòâóâà. Íå ìîæå äà ïðîäúëæèòå!',
    ...
    'ERR_GENERIC_APP_REQUEST': 'Ïîëó\xF7è ñå ãðåøêà ïðè èçïúëíÿâàíå íà çàÿâêàòà',
    ...
    'LBL_LISTVIEW': 'Ñïèñúê',
    'LBL_REFRESH': 'Îïðåñíè',
    'LBL_VIEWTYPE': 'Íà\xF7èí íà èçãëåä',
    'LBL_BOLD': 'Ïîëó\xF7åð',
    'LBL_ITALIC': 'Íàêëîíåí',
    'LBL_UNDERLINE': 'Ïîä\xF7åðòàí',
    'LBL_REGULAR': 'Îáèêíîâåí',
    'LBL_STRIKE': 'Strike',
    'LBL_INDENT': 'Èäåíòèôèêàöèÿ',
    'LBL_OUTDENT': 'Ïðåñðî\xF7âàíå',
    'LBL_UNDO': 'Ïððåìàõíè',
    'LBL_REDO': 'Îòìåíè ïðåìàõâàíåòî',
    'LBL_CUT': 'Èçðåæè',
    'LBL_UNLINK': 'Îòêà\xF7è',
    'LBL_COPY': 'Êîïèðàé',
    'LBL_PASTE': 'Ïîñòàâè',
    'LBL_INSERT': 'Äîáàâè',
